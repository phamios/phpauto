      ...
      <div class="row">
          ...
          <div class="left_content">
            <div class="single_page">
              ...
              <div class="single_page_content">
                <img class="img-center" src="<?php echo base_url('res/home');?>/img/single_post_img.jpg" alt="img">
                  ...
                  <li>
                    <div class="media">
                      <a class="media-left" href="single_page.html">
                        <img src="<?php echo base_url('res/home');?>/img/post_img1.jpg" alt="img">
                      </a>
                   ...
                   <li>
                    <div class="media">
                      <a class="media-left" href="single_page.html">
                        <img src="<?php echo base_url('res/home');?>/img/post_img2.jpg" alt="img">
                      </a>
                      <div class="media-body">
                        <a class="catg_title" href="single_page.html"> Aliquam malesuada diam eget turpis varius</a>                                
                      </div>
        ...
        <nav class="nav-slit">
              <a class="prev" href="/item1">
                ...
                <div>
                  <h3>City Lights</h3>
                  <img src="<?php echo base_url('res/home');?>/img/post_img1.jpg" alt="Previous thumb"/>
                </div>
              </a>
              <a class="next" href="/item3">
                ...
                <div>
                  <h3>Street Hills</h3>
                  <img src="<?php echo base_url('res/home');?>/img/post_img1.jpg" alt="Next thumb"/>
                </div>
              </a>
            </nav>
        <div class="col-lg-4 col-md-4 col-sm-4">
          <aside class="right_content">
            <div class="single_sidebar">
              ...
              <ul class="spost_nav">
                ...
                <li>
                  <div class="media wow fadeInDown">
                    <a href="single_page.html" class="media-left">
                      <img alt="img" src="<?php echo base_url('res/home');?>/img/post_img2.jpg">
                    </a>
                    <div class="media-body">
            ...
            <div class="single_sidebar wow fadeInDown">
              ...
              <a class="sideAdd" href="#"><img src="<?php echo base_url('res/home');?>/img/add_img.jpg" alt="img"></a>
            </div>
            <!-- End sponsor add -->
             <!-- Category Archive -->
            <div class="single_sidebar wow fadeInDown">
